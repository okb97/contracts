...
func (x *CategoryResult) GetCategories() *Category {
	if x != nil {
		if x, ok := x.Result.(*CategoryResult_Categories); ok {
			return x.Categories
		}
	}
	return nil
...
type CategoryResult_Categories struct {
	Categories *Category `protobuf:"bytes,1,opt,name=categories,proto3,oneof"`
}
...
func (*CategoryResult_Categories) isCategoryResult_Result() {}
...
const file_proto_query_proto_rawDesc = "" +
	"\n" +
	"\x11proto/query.proto\x12\x05proto\x1a\x11proto/error.proto\x1a\x12proto/models.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x1f\n" +
	...
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"\xad\x01\n" +
	"\x0eCategoryResult\x121\n" +
	"\n" +
	"categories\x18\x01 \x01(\v2\x0f.proto.CategoryH\x00R\n" +
	"categories\x12$\n" +
...
var file_proto_query_proto_depIdxs = []int32{
	...
	6,  // 3: proto.CategoryResult.categories:type_name -> proto.Category
